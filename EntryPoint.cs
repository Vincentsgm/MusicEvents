...
[assembly: Rage.Attributes.Plugin("MusicEvents", EntryPoint = "MusicEvents.EntryPoint.Main", ExitPoint = "MusicEvents.EntryPoint.Exit", PrefersSingleInstance = true)]

namespace MusicEvents
{
    public static class EntryPoint
    {
        public static string LastEventPlayed = string.Empty;

        public static MenuPool menuPool = new MenuPool();
        public static UIMenu mainMenu = new UIMenu("Music Events", "Music Events player");

        public static void Main()
        {
            foreach (string musicEvent in MusicEventList)
            {
                mainMenu.AddItem(new UIMenuItem(musicEvent));
            }
            ...
            /*TriggerMusicEvent("CMH_SILO_START");
            TriggerMusicEvent("MP_MC_CMH_SUSPENSE");*/
            ...
            while (true)
            {
                ...
                if (Game.IsKeyDown(Keys.M)) mainMenu.Visible = !mainMenu.Visible;
            }
        }
        ...
        private static void MainMenuOnItemSelect(UIMenu sender, UIMenuItem selectedItem, int index)
        {
            ClearLastMusicEvent();
            string musicEvent = selectedItem.Text;
            LastEventPlayed = musicEvent;
            TriggerMusicEvent(musicEvent);
        }

        public static void ClearLastMusicEvent()
        {
            if (LastEventPlayed != string.Empty) CancelMusicEvent(LastEventPlayed);
        }

        public static bool TriggerMusicEvent(string musicEvent) => Natives.x706D57B0F50DA710<bool>(musicEvent);
        public static bool CancelMusicEvent(string musicEvent) => Natives.x5B17A90291133DA5<bool>(musicEvent);

        public static List<string> MusicEventList = new List<string>
    {
         "AC_DELIVERED",
 "AC_DONE",
 "AC_EN_ROUTE_CULT",
